                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-4 sm:-my-px sm:ms-10 lg:flex">
                                <NavLink href={route('bk.dashboard.main')} active={route().current('bk.dashboard.main')}>
                                    Dashboard
                                </NavLink>
                                ...
                                <NavLink href={route('bk.journal.main')} active={ route().current('bk.journal.main') }>
                                  Data Jurnal
                                </NavLink>
                                <NavLink href={route('bk.attendances.main')} active={ route().current('bk.attendances.main')}>
                                  Data Presensi
                                </NavLink>
                            </div>
                        </div>
