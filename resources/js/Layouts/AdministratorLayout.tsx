                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-4 sm:-my-px sm:ms-10 lg:flex">
                                ...
                                <NavLink href={route('administrator.class')} active={route().current('administrator.class')}>
                                    Manajemen Kelas
                                </NavLink>
                                <NavLink href={route('administrator.user')} active={route().current('administrator.user')}>
                                    Manajemen Pengguna
                                </NavLink>
                                <NavLink href={route('administrator.journal')} active={route().current('administrator.journal')}>
                                    Data Jurnal
                                </NavLink>
                                <NavLink href={route('administrator.attedance')} active={route().current('administrator.attedance')}>
                                    Data Absen
                                </NavLink>
